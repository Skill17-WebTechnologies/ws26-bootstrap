...
Pinned version: **5.3.8** (WSC2026 / WorldSkills 2026 Web Technologies)
...
**What it does:** Runs the CSS/JS watch plus the Astro docs dev server.

**Open / use:** http://localhost:4321
